    ...
    <div class="bg-[#f0f2f5]">
        ...
        <a-card class="mb-4" :bordered="false">
            <a-form :model="searchForm" layout="inline" class="search-form">
                <a-form-item label="方式编号">
                    <a-input v-model:value="searchForm.methodCode" placeholder="请输入内容" style="width: 220px" />
                </a-form-item>
                <a-form-item label="方式名称">
                    <a-input v-model:value="searchForm.methodName" placeholder="请输入内容" style="width: 220px" />
                </a-form-item>
                <a-form-item>
                    <a-space>
...
// 表格数据
const tableData = ref<ManufacturingMethod[]>([]);
...
// 模拟数据
const mockData: ManufacturingMethod[] = [
    {
        id: 1,
        methodCode: 'DWBH000001',
        methodName: '自制件',
        status: 'enabled',
        remark: '无',
...
const loadData = () => {
    ...
    // 前端筛选
    if (searchForm.methodCode) {
        filteredData = filteredData.filter(item =>
            item.methodCode.toLowerCase().includes(searchForm.methodCode.toLowerCase())
        );
    }
    if (searchForm.methodName) {
        filteredData = filteredData.filter(item => item.methodName.includes(searchForm.methodName));
    }
