        ...
        <a-card class="mb-4" :bordered="false">
            <a-form :model="searchForm" layout="inline" class="search-form">
                <a-form-item label="车间编号">
                    <a-input v-model:value="searchForm.workshopCode" placeholder="请输入内容" style="width: 220px" />
                </a-form-item>
                <a-form-item label="车间名称">
                    <a-input v-model:value="searchForm.workshopName" placeholder="请输入内容" style="width: 220px" />
                </a-form-item>
                <a-form-item>
                    <a-space>
...
// 表格数据
const tableData = ref<ProcessWorkshop[]>([]);
...
// 模拟数据
const mockData: ProcessWorkshop[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    workshopCode: 'DWBH000001',
...
const loadData = () => {
    ...
    // 前端筛选
    if (searchForm.workshopCode) {
        filteredData = filteredData.filter(item =>
            item.workshopCode.toLowerCase().includes(searchForm.workshopCode.toLowerCase())
        );
    }
    if (searchForm.workshopName) {
        filteredData = filteredData.filter(item => item.workshopName.includes(searchForm.workshopName));
    }
