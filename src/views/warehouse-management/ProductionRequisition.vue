...
const columns = [
    ...
    { title: '领料单号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '物料名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '领料数量', dataIndex: 'quantity', key: 'quantity', width: 120 },
    { title: '工单号', dataIndex: 'workOrder', key: 'workOrder', width: 180 },
    { title: '领料日期', dataIndex: 'requisitionDate', key: 'requisitionDate', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `LLDH${String(i + 1).padStart(10, '0')}`,
    name: `物料${i + 1}`,
    quantity: Math.floor(Math.random() * 100),
    workOrder: `GDDH${String(i + 1).padStart(10, '0')}`,
    requisitionDate: '2025.04.24',
    creator: '李红',
}));
