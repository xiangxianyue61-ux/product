...
const columns = [
    ...
    { title: '编码编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '编码名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '编码类型', dataIndex: 'codeType', key: 'codeType', width: 150 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `BMBH${String(i + 1).padStart(10, '0')}`,
    name: `编码${i + 1}`,
    codeType: ['物料编码', '产品编码', '批次编码'][i % 3],
    creator: '李红',
