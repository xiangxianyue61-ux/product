...
const columns = [
    ...
    { title: '库区编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '库区名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '所属仓库', dataIndex: 'warehouse', key: 'warehouse', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `KQBH${String(i + 1).padStart(10, '0')}`,
    name: `库区${i + 1}`,
    warehouse: `一仓库`,
    remark: '无',
    creator: '李红',
