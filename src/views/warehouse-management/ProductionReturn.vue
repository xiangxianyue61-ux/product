...
const columns = [
    ...
    { title: '退料单号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '物料名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '退料数量', dataIndex: 'quantity', key: 'quantity', width: 120 },
    { title: '退料日期', dataIndex: 'returnDate', key: 'returnDate', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `TLDH${String(i + 1).padStart(10, '0')}`,
    name: `物料${i + 1}`,
