...
const columns = [
    ...
    { title: '调拨单号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '物料名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '调拨数量', dataIndex: 'quantity', key: 'quantity', width: 120 },
    { title: '调出仓库', dataIndex: 'fromWarehouse', key: 'fromWarehouse', width: 150 },
    { title: '调入仓库', dataIndex: 'toWarehouse', key: 'toWarehouse', width: 150 },
    { title: '调拨日期', dataIndex: 'transferDate', key: 'transferDate', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `DBDH${String(i + 1).padStart(10, '0')}`,
    name: `物料${i + 1}`,
    quantity: Math.floor(Math.random() * 100),
    fromWarehouse: `一仓库`,
    toWarehouse: `二仓库`,
    transferDate: '2025.04.24',
}));
