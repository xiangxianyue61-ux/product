...
const columns = [
    ...
    { title: '班组编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '班组名称', dataIndex: 'name', key: 'name', width: 200 },
    { title: '所属车间', dataIndex: 'workshop', key: 'workshop', width: 180 },
    { title: '班组长', dataIndex: 'leader', key: 'leader', width: 120 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `BZBH${String(i + 1).padStart(10, '0')}`,
    name: `生产班组${i + 1}`,
    workshop: `车间${Math.floor(i / 5) + 1}`,
    leader: `组长${i + 1}`,
