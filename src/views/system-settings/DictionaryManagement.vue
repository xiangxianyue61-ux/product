...
const columns = [
    ...
    { title: '字典编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '字典名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '字典类型', dataIndex: 'type', key: 'type', width: 150 },
    { title: '字典项数', dataIndex: 'itemCount', key: 'itemCount', width: 120 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `ZDBH${String(i + 1).padStart(10, '0')}`,
    name: `字典${i + 1}`,
    type: ['状态字典', '类型字典', '分类字典'][i % 3],
