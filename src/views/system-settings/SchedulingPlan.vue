...
const columns = [
    ...
    { title: '排班编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '排班名称', dataIndex: 'name', key: 'name', width: 200 },
    { title: '所属班组', dataIndex: 'team', key: 'team', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `PBBH${String(i + 1).padStart(10, '0')}`,
    name: `排班计划${i + 1}`,
    team: `生产班组${i + 1}`,
