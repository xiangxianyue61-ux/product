...
const columns = [
    ...
    { title: '规则编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '规则名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '规则类型', dataIndex: 'ruleType', key: 'ruleType', width: 150 },
    { title: '编码规则', dataIndex: 'pattern', key: 'pattern', width: 200 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `GZBH${String(i + 1).padStart(10, '0')}`,
    name: `编码规则${i + 1}`,
    ruleType: ['物料编码', '产品编码', '工单编码', '批次编码'][i % 4],
    pattern: `PREFIX${String(i + 1).padStart(6, '0')}`,
    creator: '李民浩',
