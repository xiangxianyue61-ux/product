...
const columns = [
    ...
    { title: '日历编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '日历名称', dataIndex: 'name', key: 'name', width: 200 },
    { title: '年份', dataIndex: 'year', key: 'year', width: 100 },
    { title: '工作日数', dataIndex: 'workDays', key: 'workDays', width: 120 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `RLBH${String(i + 1).padStart(10, '0')}`,
    name: `${2025 + Math.floor(i / 12)}年工作日历`,
    year: 2025 + Math.floor(i / 12),
    workDays: 250 + Math.floor(Math.random() * 20),
    creator: '李民浩',
