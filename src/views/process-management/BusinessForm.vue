...
const columns = [
    ...
    { title: '表单编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '表单名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '表单类型', dataIndex: 'formType', key: 'formType', width: 150 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `BDBH${String(i + 1).padStart(10, '0')}`,
    name: `业务表单${i + 1}`,
    formType: ['审批表单', '申请表单', '记录表单'][i % 3],
    creator: '刘超',
