...
const columns = [
    ...
    { title: '产品编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '产品名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '批次号', dataIndex: 'batch', key: 'batch', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `CPBH${String(i + 1).padStart(10, '0')}`,
    name: `产品${i + 1}`,
    batch: `PC${String(i + 1).padStart(8, '0')}`,
    creator: '刘超',
