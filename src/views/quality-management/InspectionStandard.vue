...
type Row = { id: number; code: string; name: string; creator: string; createTime: string };
...
const columns = [
    ...
    { title: '检验标准编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '检验标准名称', dataIndex: 'name', key: 'name', width: 240 },
