...
const columns = [
    ...
    { title: '检验项目编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '检验项目名称', dataIndex: 'name', key: 'name', width: 220 },
