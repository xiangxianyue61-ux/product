...
const columns = [
    ...
    { title: '处理方式编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '处理方式名称', dataIndex: 'name', key: 'name', width: 220 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `CLFS${String(i + 1).padStart(10, '0')}`,
    name: ['返工', '返修', '报废', '让步接收'][i % 4],
    remark: '无',
    creator: '刘超',
