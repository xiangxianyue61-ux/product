...
const columns = [
    ...
    { title: '点检单号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '设备名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '点检类型', dataIndex: 'inspectionType', key: 'inspectionType', width: 120 },
    { title: '点检日期', dataIndex: 'inspectionDate', key: 'inspectionDate', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `DJDH${String(i + 1).padStart(10, '0')}`,
    name: `设备${i + 1}`,
    inspectionType: ['日常巡检', '定期点检'][i % 2],
