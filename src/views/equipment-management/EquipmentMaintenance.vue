...
const columns = [
    ...
    { title: '保养单号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '设备名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '保养状态', dataIndex: 'status', key: 'status', width: 120 },
    { title: '保养日期', dataIndex: 'maintenanceDate', key: 'maintenanceDate', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `BYDH${String(i + 1).padStart(10, '0')}`,
    name: `设备${i + 1}`,
    status: '已完成',
    maintenanceDate: '2025.04.24',
    creator: '刘超',
