...
const columns = [
    ...
    { title: '维修状态', dataIndex: 'status', key: 'status', width: 120 },
    { title: '维修日期', dataIndex: 'repairDate', key: 'repairDate', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `WXDH${String(i + 1).padStart(10, '0')}`,
    name: `设备${i + 1}`,
    status: '维修中',
    repairDate: '2025.04.24',
    creator: '刘超',
