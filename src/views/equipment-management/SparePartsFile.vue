...
const columns = [
    ...
    { title: '备件编号', dataIndex: 'code', key: 'code', width: 180 },
    { title: '备件名称', dataIndex: 'name', key: 'name', width: 220 },
    { title: '规格型号', dataIndex: 'model', key: 'model', width: 180 },
...
const mock: Row[] = Array.from({ length: 56 }, (_, i) => ({
    id: i + 1,
    code: `BJBH${String(i + 1).padStart(10, '0')}`,
    name: `备件${i + 1}`,
    model: `GGXH${String(i + 1).padStart(6, '0')}`,
